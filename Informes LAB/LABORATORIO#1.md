...
- **Origen:** Se trabajó con un archivo de ventas en formato `.csv` (`ventas.csv`).
  ![Archivo ventas.csv](../ImagenesLab/imagenes/image.png)
- **Configuración:** Se configuró el step **CSV File Input** con delimitador `,` y la opción **Header row present** activada, detectando los campos automáticamente.
  ![Configuración del CSV File Input](../ImagenesLab/imagenes/image-1.png)
...
- **Operación:** Se definió el campo `subtotal` mediante la multiplicación: `precio_unitario * cantidad`.
  ![Configuración del Calculator](../ImagenesLab/imagenes/image-2.png)
...
- **Campos:** Se incluyeron mediante **Get Fields** las columnas originales y el nuevo cálculo de subtotal.
  ![Pestaña General](../ImagenesLab/imagenes/image-3.png)
  ![Pestaña Fields](../ImagenesLab/imagenes/image-4.png)

### 4. Ejecución y Validación
- **Resultado:** El proceso finalizó correctamente generando el archivo `resultados_0.json`.
  ![Ejecución exitosa](../ImagenesLab/imagenes/image-6.png)
  ![Contenido JSON generado](../ImagenesLab/imagenes/image-5.png)
...
<div align="center">
  <img src="../ImagenesLab/Recursos_ETL_YAML-SQL_Quilumba/00_Transformation_Flow.png" width="85%"/>
  <p><i>Fig 1. Transformation Flow.</i></p>
</div>

<div align="center">
  <img src="../ImagenesLab/Recursos_ETL_YAML-SQL_Quilumba/01_YAML_Input_Fields.png" width="85%"/>
...
<div align="center">
  <img src="../ImagenesLab/Recursos_ETL_YAML-SQL_Quilumba/02_JavaScript_Script.png" width="85%"/>
  <p><i>Fig 3. JavaScript Script.</i></p>
</div>

<div align="center">
  <img src="../ImagenesLab/Recursos_ETL_YAML-SQL_Quilumba/03_Canvas_Paso_Medio.png" width="85%"/>
...
<div align="center">
  <img src="../ImagenesLab/Recursos_ETL_YAML-SQL_Quilumba/04_Conexion_BD_Hypersonic.png" width="85%"/>
  <p><i>Fig 5. Conexión BD Hypersonic.</i></p>
</div>

<div align="center">
  <img src="../ImagenesLab/Recursos_ETL_YAML-SQL_Quilumba/05_SQL_CREATE_Table.png" width="85%"/>
  <p><i>Fig 6. SQL CREATE Table.</i></p>
</div>

<div align="center">
  <img src="../ImagenesLab/Recursos_ETL_YAML-SQL_Quilumba/06_Table_Output_Configuracion.png" width="85%"/>
...
<div align="center">
  <img src="../ImagenesLab/Recursos_ETL_YAML-SQL_Quilumba/07_Step_Metrics_Resultados.png" width="85%"/>
  <p><i>Fig 8. Step Metrics Resultados.</i></p>
</div>

<div align="center">
  <img src="../ImagenesLab/Recursos_ETL_YAML-SQL_Quilumba/08_Preview_Data_Enriquecida.png" width="85%"/>
